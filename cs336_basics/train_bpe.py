# For simplexity, I skipped the implementation of this script
# This is from https://github.com/Louisym/Stanford-CS336-spring25/blob/main/assignment1-basics/scripts/train_bpe.py
import os
import sys
import pickle
import pathlib
